...
* **Anticipation of Change** – consider future needs when designing your software 🛸
* **Maintainability** – write features that's easy to understand and modify 🚑
* **Scalability** – system s'd increased demand without failing or excessively slowing down 🥖
...
* **Continuous Delivery** 📯
* **Resiliency** – ability to withstand or recover quickly: load balance, fault tolerance, graceful degradation 🛡️
...
<Card title="4 Object-Oriented Programming Principles" icon="emoji:four-leaf-clover">
