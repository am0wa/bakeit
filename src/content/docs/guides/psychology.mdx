...
<Icon name="emojione-monotone:alien" class="icon" size="1.333em"/>

### <h3 class="hidden">Confirmation bias</h3>
<Card title="Confirmation bias" icon="emojione-monotone:ballot-box-with-ballot">
...
<Card title="Loss aversion" icon="emojione-monotone:chart-decreasing">
...
<Card title="Planning fallacy" icon="emojione-monotone:spiral-calendar">
...
<Card title="Decision fatigue" icon="emojione-monotone:anxious-face-with-sweat">
...
<Card title="Anchoring effect" icon="emojione-monotone:anchor">
...
<Card title="Cognitive dissonance" icon="emojione-monotone:disappointed-face">
...
<Card title="Negativity bias" icon="emojione-monotone:television">
...
<Card title="Recency bias" icon="emojione-monotone:telephone-receiver">
...
<Card title="Peak-end rule" icon="emojione-monotone:snow-capped-mountain">
...
<Card title="Pattern matching" icon="emojione-monotone:film-frames">
...
<Card title="The Scarcity effect" icon="emojione-monotone:chocolate-bar">
...
<Card title="Social desirability bias" icon="emojione-monotone:heart-decoration">
...
<Card title="Endowment effect" icon="emojione-monotone:fishing-pole">
...
<Card title="Hick's law" icon="emojione-monotone:thinking-face">
...
<Card title="Ego depletion" icon="emojione-monotone:person-in-bed">
