...
description: Psychological biases in software development
---
...
<Card title="Confirmation bias" icon="emoji:ballot-box-with-ballot">
  ...
  <p>`Seeing what U want to see` <small>might lead to missed opportunities and rejections</small></p>
</Card>
...
<Card title="Peak-end rule" icon="emoji:snow-capped-mountain">
  ...
  <p>`Judging peak and end experience`<small>can influence overall perception</small></p>
</Card>
...
### <h3 class="hidden">Occam’s razor</h3>
<Card title="Occam’s razor" icon="emoji:razor">
  Don’t create extra entities without necessity, the simplest one is usually the best
  <p>`Any extra items U add`<small>increase complexity and possibility of errors</small></p>
</Card>
