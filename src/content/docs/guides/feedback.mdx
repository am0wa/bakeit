...
_"Conversation **started on a negative note**, usually brings more such comments & often **ends on a negative note too**"
– Am0wA_
:::
...
_"Accusations based on **assumptions framed as facts** made on behalf of others, are **destructive** and lead to **resentful outcomes**"
– Am0wA_
:::
...
<Subtitle title={"Put Urself in other's shoes"} icon="twemoji:running-shoe"/>
