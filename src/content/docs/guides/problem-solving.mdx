...
* **Do the Right things** – then do things right [(Theory of Constraints)](../../learn/quick-start/#theory-of-constraints) 🎯
...
### <h3 class="hidden">One-way vs Two-way Doors</h3>
<Card title="One-way vs Two-way Doors" icon="emoji:door">
  * **Two-way door** – reversible, decide fast, walk back if wrong
  * **One-way door** – irreversible, slow down, deliberate

  Jeff Bezos' framing, Amazon's 2015 letter

  Most calls are two-way doors treated like one-way ones – speed is free there
</Card>
...
- [“Type 1 & Type 2 decisions” – Jeff Bezos, 2015 Letter to Shareholders](https://s2.q4cdn.com/299287126/files/doc_financials/annual/2015-Letter-to-Shareholders.PDF)
